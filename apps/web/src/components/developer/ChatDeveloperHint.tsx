...
export function ChatDeveloperHint(): ReactElement {
	return (
		<section
			className="runa-card runa-card--subtle runa-migrated-components-developer-chatdeveloperhint-1"
			aria-label="Developer Mode notice"
		>
			<div className="runa-migrated-components-developer-chatdeveloperhint-2">
